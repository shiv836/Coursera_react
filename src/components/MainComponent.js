  ...
  render() {
    const HomePage = () => {
      return(
          ...
          comment={this.props.comments.comments.filter((comments)=>comments.featured)[0]}/>
      );
    }
    const AboutUs=()=>{
...
return (
       ...
       )[0]} comment={this.props.comments.comments.filter((comment)=> comment.dishId ===parseInt(match.params.dishId,10))}
